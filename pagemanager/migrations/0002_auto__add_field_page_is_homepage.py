...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.is_homepage'
        db.add_column('pagemanager_page', 'is_homepage', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.is_homepage'
        db.delete_column('pagemanager_page', 'is_homepage')
