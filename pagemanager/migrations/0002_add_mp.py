...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.materialized_path'
        db.add_column('pagemanager_page', 'materialized_path', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.materialized_path'
        db.delete_column('pagemanager_page', 'materialized_path')
    ...
    models = {
        ...
        'pagemanager.page': {
            ...
            'materialized_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
